...
while(1):
    ...
    #control signals
    #  10 00110101 11111001
    #  100011 010111 111001
    ju.write(convert_to_byte("10111001"))
    ju.write(convert_to_byte("01010111"))
    ju.write(convert_to_byte("10100011"))
    ju.write(convert_to_byte("01011011"))
